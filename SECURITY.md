...
If you find a security vulnerability in **dart_sei**, report it privately before disclosing it publicly.

**Preferred channel:**
Email — `legal.sxnnyside@sxnnysideproject.com`

**Alternative:**
[GitHub Private Security Advisory](https://github.com/sxnnyside-project/dart-sei/security/advisories/new)
...
This policy covers the **dart_sei** repository only.
